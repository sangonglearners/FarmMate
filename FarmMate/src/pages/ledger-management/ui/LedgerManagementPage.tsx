...
export default function LedgerManagementPage() {
  ...
  const [statusFilter, setStatusFilter] = useState<"all" | "unregistered">("all");
  ...
  }, [tasks, ledgerTaskIds, statusFilter]);
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="space-y-4">
        ...
        {/* 상태 필터 */}
        <Select value={statusFilter} onValueChange={(value: "all" | "unregistered") => setStatusFilter(value)}>
          <SelectTrigger>
